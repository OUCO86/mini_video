...
// 1. 核心 API 和加载器
#include "FidelityFX-SDK/FidelityFX/api/include/ffx_api.h"
#include "FidelityFX-SDK/FidelityFX/api/include/ffx_api_loader.h"
#include "FidelityFX-SDK/FidelityFX/api/include/ffx_fsr2.h" 
#include "FidelityFX-SDK/FidelityFX/api/include/ffx_fsr3upscaler.h" // 如果您要用FSR3

// 2. 【非常重要】DX12 的后端实现文件
// 新版 SDK 必须包含这个，否则无法在 DX12 下工作
#include "FidelityFX-SDK/FidelityFX/api/include/dx12/ffx_dx12.h"
#include "FidelityFX-SDK/FidelityFX/api/include/dx12/ffx_api_dx12.h"
...
int main(int argc, char* argv[])
{
	...
	while (!exiting)
	{
		...
		{
				// 1. 资源状态转换：准备输入(NV12)和输出(Swapchain UAV)
